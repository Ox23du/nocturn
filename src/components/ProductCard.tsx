  ...
  return (
    ...
    >
      <div className="card-product aspect-[3/4] rounded-sm overflow-hidden mb-4">
        ...
        {/* Hover Overlay - Improved Add to Cart UX */}
        <motion.div
          initial={{ opacity: 0 }}
          whileHover={{ opacity: 1 }}
          className="absolute inset-0 bg-gradient-to-t from-background/95 via-background/30 to-transparent z-10 flex flex-col items-center justify-end gap-4 pb-12 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
        >
      ...
      <div className="space-y-1">
        ...
        <h3 className="text-sm font-semibold tracking-tight group-hover:text-muted-foreground transition-colors">
          {name}
        </h3>
